  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <motion.div
        ...
        className="bg-white w-5/6 md:w-2/5 shadow-[2px_2px_0px_0px] shadow-gray-300 text-black px-8 py-8 rounded-lg flex flex-col items-center justify-center gap-6 relative"
      >
        <button
